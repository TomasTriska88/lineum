...
**Per Run:**
- `_<run_tag>_whitepaper_contract_result.json`: Detailed validation results.

**Suite Mode (in runs-root):**
- `whitepaper_contract_suite.json`: Aggregated results for all runs.
- `whitepaper_contract_suite.md`: Markdown summary table.

## Example Run

To verify a single run:

```bash
python tools/whitepaper_contract.py --run-dir output_wp/runs/spec6_false_s41_20260214_101645
```
