...
*   **[GitHub Repository (lineum-core)](https://github.com/TomasTriska88/lineum-private):** Zdrojový kód, CI/CD pipeline a audit tools. *(Private Access / Invite Only)*
...
3.  **Laboratoř (Simulacrum):**
    ...
    *   **3D Projekce:** Vizualizujeme 2D pole jako 3D krajinu, kde osa **Z reprezentuje potenciál $\phi$**. To odhaluje hloubku "gravitačních jam" a topologii atraktorů, které v plochém 2D pohledu zanikají.

> **Důležité: Repozitář je z důvodu interního testování (Stealth Mode) uzavřen veřejnosti. Vám však velmi rád udělím plný přístup (Collaborator), abyste mohl nahlédnout přímo "pod kapotu". Stačí odpovědět na tento mail.**
