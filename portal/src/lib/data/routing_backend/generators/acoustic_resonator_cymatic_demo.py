...
def run_acoustic_resonator_demo(element_name="Carbon", frequency=4.0, radius=0.3, confinement_strength=0.9):
    """
    DISCLAIMER: This is an Acoustic / Cymatic Resonator demo, NOT Quantum Chemistry!
    It places an acoustic continuous "speaker" wave at the center of a structural kappa-bowl (glass bell)
    to visually demonstrate the standing stationary states (Cymatics) generated by the Lineum Engine.
    """
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    print(f"[*] Running Acoustic Cymatic Resonator Demo for '{element_name}' on: {device}")
...
if __name__ == "__main__":
    # Test Carbon-like frequency with Confinement
    run_acoustic_resonator_demo(element_name="Carbon", frequency=4.0, radius=0.3, confinement_strength=0.9)
