...
A reproducible, parameter-light emergence of a **stable localized excitation** (“linon”) with a canonical, **bin-centered** tone _f₀_, **seed-invariant** across runs. All SI quantities (E, λ, display-only m/mₑ) are direct unit conversions from _f₀_. Tooling guardrails (commit stamping, HTML ground truth, CIs) make it **auditable and falsifiable**.
...
- Bundle: `output/evidence_v1.0.4-core.zip`

## What’s in the paper (core)

- **Claim:** reproducible localized excitation with bin-centered _f₀_, SI-anchored conversions, and seed invariance.
...
Tomáš Tříska. _Lineum Core (v1.0.4-core)._ 2025. DOI: [10.5281/zenodo.16934359](https://doi.org/10.5281/zenodo.16934359).  
_(This release corresponds to Git tag `v1.0.4-core`; HTML/CSV/PNG artifacts live in `output/` and are commit-stamped.)_

BibTeX:

```bibtex
@software{triska2025_lineumcore_v104,
  author = {Tomáš Tříska},
  title  = {Lineum Core (v1.0.4-core)},
  year   = {2025},
  doi    = {10.5281/zenodo.16934359},
  url    = {https://doi.org/10.5281/zenodo.16934359},
  note   = {Core manuscript: whitepaper/lineum-core.md (CC BY 4.0). Code: MIT.}
}
```
...
Open-source; permissive license recommended (e.g., MIT). See `LICENSE`.
