> **Ověřovací status:**
>
> Pozorovaná emergentní gravitace je hypotetickým výkladem vycházejícím z rovnice evoluce φ a dynamiky kvazičástic.
> Veškeré pozorování je v současnosti založeno na kvalitativních výstupech – stabilitě φ-pastí, jejich vzniku a vazbě na trajektorie částic.
>
> Kvantitativní potvrzení těchto vztahů je předmětem dalšího výzkumu a je uvedeno jako priorita v `todo.md`.
...
- **Tříska’s Dimensional Transparency Hypothesis:** zatím neprokázána.  
  Testovací běhy obsahovaly pouze gradientní ladicí pole κ.  
  I když struktury slábly v oblastech s nižším κ, nebyl použit ostrovní režim, který je klíčový pro potvrzení hypotézy o průhlednosti.  
  Výsledky tedy zatím nejsou dostatečné k jejímu potvrzení.
