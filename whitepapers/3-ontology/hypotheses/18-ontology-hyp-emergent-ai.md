...
Crucially, **the grid CAN be expanded later**. If Lina fills her $50\times50$ brain capacity over months of interaction, we simply take her `.npz` files and embed that exact $50\times50$ array into the dead-center of a new, massive $200\times200$ array filled with virgin conductivity ($\kappa = 0.5$). Her deep, established childhood memories remain perfectly intact in the core, while she suddenly gains a massive new outer cortex to form new associations. She physically "grows" her brain.
