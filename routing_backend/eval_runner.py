...
def run_memory_rigor_pack():
    ...
    print(f"{'GRID':<5} | {'DT':<4} | {'SEED':<4} | {'DIV_A':<8} | {'DIV_B':<8} | {'RES_A':<8} | {'RES_B':<8} | {'TAU_R':<6} | {'p50':<8} | {'p90':<8} | {'p99':<8}")
    print("-" * 110)
    for r in results:
        print(f"{r['grid']:<5} | {r['dt']:<4.1f} | {r['seed']:<4} | {r['div_A']:<8.4f} | {r['div_B']:<8.4f} | {r['res_A']:<8.4f} | {r['res_B']:<8.4f} | {r['tau_ratio']:<6.4f} | {r['p50']:<8.2e} | {r['p90']:<8.2e} | {r['p99']:<8.2e}")
